...
<img src="https://github.com/devtechedge.png?size=48" width="32" height="32" alt="aarop" align="left" /> **[aarop #2](https://github.com/devtechedge/aarop/pull/2)** — drop CSP that broke next-dev Playwright e2e
...
<img src="https://github.com/devtechedge.png?size=48" width="32" height="32" alt="luxe-tracker" align="left" /> **[luxe-tracker #7](https://github.com/devtechedge/luxe-tracker/pull/7)** — actually remove double comma after typescript block
...
<img src="https://github.com/devtechedge.png?size=48" width="32" height="32" alt="notion-clone" align="left" /> **[notion-clone #2](https://github.com/devtechedge/notion-clone/pull/2)** — convert next.config.ts to next.config.mjs for Next 14
...
<img src="https://github.com/pytest-dev.png?size=48" width="32" height="32" alt="pytest-env" align="left" /> **[pytest-env #262](https://github.com/pytest-dev/pytest-env/pull/262)** — document [pytest] env configuration in pytest.toml / .pytest.toml
...
<img src="https://github.com/devtechedge.png?size=48" width="32" height="32" alt="regulatory_compliance" align="left" /> **[regulatory_compliance #2](https://github.com/devtechedge/regulatory_compliance/pull/2)** — array.from for Set + restore data/frameworks seed

<img src="https://github.com/devtechedge.png?size=48" width="32" height="32" alt="regulatory_compliance" align="left" /> **[regulatory_compliance #3](https://github.com/devtechedge/regulatory_compliance/pull/3)** — restore full data/ seed tree for backend + e2e

<img src="https://github.com/devtechedge.png?size=48" width="32" height="32" alt="regulatory_compliance" align="left" /> **[regulatory_compliance #4](https://github.com/devtechedge/regulatory_compliance/pull/4)** — allow localhost API in CSP connect-src for e2e
...
<img src="https://github.com/devtechedge.png?size=48" width="32" height="32" alt="veritas-engine" align="left" /> **[veritas-engine #3](https://github.com/devtechedge/veritas-engine/pull/3)** — drop CSP that broke next-dev Playwright e2e
