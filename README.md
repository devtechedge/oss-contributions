...
| Repo | PR | What | Merged |
| --- | --- | --- | --- |
| <img src="https://github.com/PyO3.png?size=40" width="18" /> [PyO3/maturin](https://github.com/PyO3/maturin) | [#3302](https://github.com/PyO3/maturin/pull/3302) | find_all_windows() now lossy-decodes py --list-paths and conda info -e output instead of unwrapping str::from_utf8, so a Windows build with localized (non-UTF-8) interpreter output skips the affected line rather than panicking and aborting the build; added a unit test covering the non-UTF-8 decode path. | 16 Sep 2026 |
