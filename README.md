...
| Repo | PR | What | Merged |
| --- | --- | --- | --- |
| <img src="https://github.com/stellar.png?size=40" width="18" /> [stellar/stellar-docs](https://github.com/stellar/stellar-docs) | [#2849](https://github.com/stellar/stellar-docs/pull/2849) | Handle malformed XDR in the address conversion example | 14 Sep 2026 |
